...
class MainActivity : FlutterActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun configureFlutterEngine(flutterEngine: FlutterEngine) {
        ...
        EventChannel(
            ...
            object : EventChannel.StreamHandler {
                override fun onListen(arguments: Any?, eventSink: EventChannel.EventSink) {
                    val receiver = VpnStatusBroadcastReceiver()
                    receiver.setListener(object : VpnStatusListener {
        ...
        EventChannel(
            ...
            object : EventChannel.StreamHandler {
                override fun onListen(arguments: Any?, eventSink: EventChannel.EventSink) {
                    val receiver = VpnPingBroadcastReceiver()
                    receiver.setListener(object : VpnPingListener {
        ...
        EventChannel(
            ...
            object : EventChannel.StreamHandler {
                override fun onListen(arguments: Any?, eventSink: EventChannel.EventSink) {
                    val receiver = VpnAllRealPingBroadcastReceiver()
                    receiver.setListener(object : VpnAllRealPingListener {
            ...
            when (call.method) {
                ...
                "testCurrentServerRealPing" -> {
                    if (mainViewModel.isRunning.value == true) {
                        ...
                        toast("You'r not connected!!")
                    }
                }
     "disconnect" -> {
                    // toast("${mainViewModel.isRunning.value}")
                    if (mainViewModel.isRunning.value == true) {
                        Utils.stopVService(this)
                        result.success(true)
                    }
